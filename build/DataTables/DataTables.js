...
var DataTables = function (_Component) {
  ...
  function DataTables(props, context) {
    ...
    _this.handleHeaderColumnClick = function (event, rowIndex, columnIndex) {
      if (_this.props.disableOnLoading && _this.props.loading) return;
  ...
  (0, _createClass3.default)(DataTables, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          disableOnLoading = _props.disableOnLoading,
          ...
          other = (0, _objectWithoutProperties3.default)(_props, ['title', 'titleStyle', 'filterHintText', 'fixedHeader', 'fixedFooter', 'footerToolbarStyle', 'stripedRows', 'showRowHover', 'selectable', 'multiSelectable', 'enableSelectAll', 'deselectOnClickaway', 'disableOnLoading', 'showCheckboxes', 'height', 'showHeaderToolbar', 'showFooterToolbar', 'rowSize', 'rowSizeLabel', 'rowSizeList', 'showRowSizeControls', 'summaryLabelTemplate', 'columns', 'data', 'page', 'toolbarIconRight', 'count', 'loading', 'tableStyle', 'tableBodyStyle', 'tableHeaderColumnStyle', 'tableHeaderStyle', 'tableRowColumnStyle', 'tableRowStyle', 'tableWrapperStyle', 'headerToolbarMode', 'filterValue', 'showHeaderToolbarFilterIcon']);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          _DataTablesTable2.default,
          {
            ...
            selectable: selectable && !this.props.disableOnLoading || selectable && this.props.disableOnLoading && !this.props.loading,
...
DataTables.propTypes = {
  ...
  disableOnLoading: _propTypes2.default.bool,
